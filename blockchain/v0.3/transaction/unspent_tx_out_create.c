...
/**
 * unspent_tx_out_create - Allocates and initializes an unspent transaction output structure
 * @block_hash: Hash of the Block where the referenced transaction output is located
 * @tx_id: Hash of a transaction in the Block block_hash
 * @out: Pointer to the referenced transaction output
 *
 * Return: Pointer to the created unspent transaction output upon success, or NULL upon failure
 */
